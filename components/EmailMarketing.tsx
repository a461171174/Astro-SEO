        ...
        <div className="flex items-center gap-4">
          <div className="px-4 py-2 bg-slate-100 rounded-lg border border-slate-200 flex items-center gap-3">
            <div className="space-y-0.5">
              <p className="text-[11px] text-slate-400 font-bold uppercase">本月额度</p>
        ...
        {stats.map((stat, i) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-bold text-green-600 bg-green-50 px-1.5 py-0.5 rounded border border-green-100">+12%</span>
            </div>
            <div>
              ...
              <tr key={c.id} className="hover:bg-slate-50/50 transition-colors group">
                <td className="p-4">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[11px] text-slate-400 truncate max-w-[200px]" title={c.subject}>{c.subject}</p>
                  </div>
                </td>
